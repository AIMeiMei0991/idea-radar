...
const RELEVANT_KW = [
  '效率','工具','App','应用','软件','工作流','生产力','自动化',
  '独立开发','创业','副业','一人','开发者','程序员',
  'AI','大模型','GPT','Claude','提示词','Prompt',
  '笔记','写作','知识管理','信息管理','收集','整理',
  '财务','记账','时间管理','任务管理','项目管理',
  'macOS','iOS','快捷指令','Shortcuts','插件',
  '设计','UI','UX','原型',
  '赚钱','收入','变现','付费','订阅',
];

const IRRELEVANT_KW = [
  '手机评测','相机','镜头','耳机测评','显示器','键盘开箱',
