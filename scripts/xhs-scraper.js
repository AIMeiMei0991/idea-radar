...
const XHS_SEED_DATA = [
  ...
  {
    title: '30岁，一个人的第6年，其实真的很孤独',
    desc: '6年前觉得自由万岁，现在偶尔在深夜盯着天花板发呆。"孤独是有声音的，是冰箱的嗡鸣，是手机自动锁屏的咔嗒。"习惯性凑满减点两份饭，放进冰箱时突然想起妈妈说的话。睡前养成了和Siri聊天的怪癖："今天天气怎么样？"其实窗外正下着暴雨，但比起雨声，更想听见人类的回应。独居生活最大的痛点不是不便利，而是缺乏真实的人类连接和情感回应。AI伴侣/情感陪伴工具有真实市场需求。',
    url: 'https://www.xiaohongshu.com/explore/686654680000000012015d69',
    category: '情感'
  },
  {
    title: 'Work from home太久，抑郁了',
    desc: 'Full time WFH 2年后心理和生理都出现问题。恶性循环：家里太舒服→工作分心→晚上内疚补工作→为了玩晚睡→第二天更分心。Remote work depression是真实现象。最终解决方案：就近租工位，重新获得物理边界。远程工作的隐性代价：缺乏物理分隔导致工作与生活持续混合，大脑无法真正切换状态。需要帮助远程工作者维持物理边界和心理切换的工具。',
    url: 'https://www.xiaohongshu.com/explore/6836b4450000000012007b1b',
    category: '效率'
  },
  {
    title: '居家办公内幕：看似自由，实则被榨干',
    desc: '线下办公到点上下班边界清晰；居家后变成24小时随时在岗。省下的通勤时间被老板占用，老板不分昼夜发消息，件件标为急事。远程办公最大的问题：雇主和员工对"在家工作"的边界认知完全不同，员工失去了下班边界。真正需要的不是远程工作工具，而是帮助远程工作者设定和保护工作边界、拒绝隐性加班的工具。',
    url: 'https://www.xiaohongshu.com/explore/698cad8b000000001a0213ca',
    category: '效率'
  },
  {
    title: '居家办公给不了我想要的自由',
    desc: '对比线下工作后，对远程办公感受更清晰：WFH里的自由是伪命题。只有极度自律且目标清晰的人，才能把自由转化成高效产出。对多数人来说，remote让工作和生活边界更模糊了，事情没少反而更碎，心理上始终悬着一根线。远程工作需要极强的自我管理能力，而这本身就是一种工具需求——帮助不够自律的远程工作者维持专注和产出稳定性。',
    url: 'https://www.xiaohongshu.com/explore/694e5817000000001e03072a',
    category: '效率'
  },
  {
    title: '杨天真：我劝大部分人，别做"个人IP"',
    desc: '真正的IP是活成一家"公司"。先深度了解自己，找到真正热爱且不怕议论的特质，内核不稳一切白费。内容形式让自己舒服，价值要对别人有用，拒绝爹味说教，核心是利他。大部分人失败在：把IP当"人设"在经营，而不是做真实的自己。个人IP最大的痛点：大多数人不知道自己真正擅长什么、能为别人解决什么问题。需要帮助创作者找到自己差异化定位和内容方向的工具。',
    url: 'https://www.xiaohongshu.com/explore/69848d17000000000b0086e1',
    category: '内容创作'
  }
];
